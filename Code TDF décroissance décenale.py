...
- Allocation adaptative selon l'âge
...
PROFILS = {
    "PRUDENT": {
        ...
        "allocation_jeune": 0.30,  # 30% equity max
        "allocation_age_mur": 0.15,
        "allocation_senior": 0.05
    },
    "MODERE": {
        ...
        "allocation_jeune": 0.50,
        "allocation_age_mur": 0.35,
        "allocation_senior": 0.20
    },
    "EQUILIBRE": {
        ...
        "allocation_jeune": 0.70,
        "allocation_age_mur": 0.50,
        "allocation_senior": 0.30
    },
    "DYNAMIQUE": {
        ...
        "allocation_jeune": 0.85,
        "allocation_age_mur": 0.65,
        "allocation_senior": 0.40
    },
    "AGRESSIF": {
        ...
        "allocation_jeune": 0.95,
        "allocation_age_mur": 0.80,
        "allocation_senior": 0.60
    }
}
...
print(f"Allocation jeune (< 40 ans): {profil['allocation_jeune']*100:.0f}% equity")
print(f"Allocation âge mûr (40-60 ans): {profil['allocation_age_mur']*100:.0f}% equity")
print(f"Allocation senior (> 60 ans): {profil['allocation_senior']*100:.0f}% equity")
...
def calculer_allocation(age):
    """
    Allocation basée sur l'âge et le profil choisi
    """
    if age < 40:
        pct_equity = profil['allocation_jeune']
    elif age < 60:
        pct_equity = profil['allocation_age_mur']
    else:
        pct_equity = profil['allocation_senior']
